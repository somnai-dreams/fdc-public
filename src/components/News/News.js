...
let all_html = [html1, html2, html3];

let headlines = [
  {text: "Additional Balancing FAQs"},
  {text: "Update your details on Child Care Finder"},
  {text: "Understanding CCS balancing presentation "}
]
